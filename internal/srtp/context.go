...
type Context interface {
	...
	EncryptRTCP([]byte) ([]byte, error)
}

func SplitKeyingMaterial(keyingMaterial []byte, isClient bool) (localWriteKey, remoteWriteKey []byte) {
	offset := 0
...
func newContextBase(masterKey, masterSalt []byte, profile string) (c *contextBase, err error) {
...
func (c *contextBase) generateSessionKey(label byte) ([]byte, error) {
...
func (c *contextBase) generateSessionSalt(label byte) ([]byte, error) {
	// https://tools.ietf.org/html/rfc3711#appendix-B.3
...
func (c *contextBase) generateSessionAuthTag(label byte) ([]byte, error) {
	// https://tools.ietf.org/html/rfc3711#appendix-B.3
...
func (c *contextBase) generateCounter(sequenceNumber uint16, rolloverCounter uint32, ssrc uint32, sessionSalt []byte) []byte {
...
func (c *contextBase) generateAuthTag(buf, authTag []byte) ([]byte, error) {
...
// func (c *contextBase) verifyAuthTag(buf, expectedAuthTag, authTag []byte) (bool, error) {
